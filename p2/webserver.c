...
/* 
VULNERABILITY:
byte is 8-bit signed two's compliment integer, int is 32-bit
Since this function takes in a byte, it looks at last 8 bits of the length of the given string.
This check will pass if last 8-bits are less than 100.
If a large string is passed, the buffer will overflow.
*/
